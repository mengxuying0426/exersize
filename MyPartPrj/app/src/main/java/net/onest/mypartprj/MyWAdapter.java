...
public class MyWAdapter extends BaseAdapter {
     ...
     * 实例化Adapter
     */
    public MyWAdapter(Context context, List<QuestionBank> dataSet)
    {
        ...
        if (convertView == null) {
            ...
            holder.btnStartTi.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("fenlei",mQList.get(position).getKemu()+"&"+mQList.get(position).getTinum());
...
//
//import net.onest.mypartprj.beans.QuestionBank;
//import net.onest.mypartprj.beans.WrongSet;
//
//import java.util.List;
//
//public class MyWAdapter extends BaseAdapter {
...
//                    Intent intent = new Intent();
//                    intent.setClass(myContext, WrongTiListActivity.class);
//                    intent.putExtra("tikufenlei",mQList.get(position).getKemu());
//                    myContext.startActivity(intent);
//                }
//            });
//        }else{
