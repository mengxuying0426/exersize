...
import net.onest.mxy.beans.WTiInfo;
import net.onest.mxy.beans.WrongTi;
import net.onest.mxy.utils.DbUtil;

/**
 * Servlet implementation class DownloadDetailServlet
 */
@WebServlet("/DownloadDetailServlet")
public class DownloadDetailServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(null == str) {
			...
			try {
				con = DbUtil.getCon();
				pstm = con.prepareStatement("select * from wrongti1 where id = ?");
				pstm.setInt(1, id1);
